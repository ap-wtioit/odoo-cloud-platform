...
if env_is_true('ODOO_SESSION_REDIS'):
    if sentinel_host:
    ...
    if env_is_true('ODOO_SESSION_REDIS_COPY_EXISTING_FS_SESSIONS'):
        copy_fs_sessions(odoo.tools.config.session_dir)
    if env_is_true('ODOO_SESSION_REDIS_PURGE_EXISTING_FS_SESSIONS'):
